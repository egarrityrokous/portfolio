...
public class HashDiff extends Diff {
	...
	// hash table instance variable to store previously-calculated diffs
	protected Hashtable<IntPair, Association<Integer, String>> diffTable;
	...
	*/
	public HashDiff(String file1Name, String file2Name) {
		...
		diffTable = new Hashtable<IntPair, Association<Integer, String>>();
	}
	...
	public Association<Integer, String> diffHelper(int remainingFile1Index, int
		...
		// initialize new IntPair with the given file indices
		IntPair fileIntPair = new IntPair(remainingFile1Index, remainingFile2Index);

		// if fileIntPair is already in diffTable and is not null, return it
		if (diffTable.get(fileIntPair) != null) {
			return diffTable.get(fileIntPair);
		}
		...
		diffTable.put(fileIntPair, retVal);
